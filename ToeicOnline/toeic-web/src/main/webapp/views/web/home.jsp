...
==================================================-->
	<div id="myCarousel" class="carousel slide">
					...
					<div class="row">
						<div class="span6">
							<div class="carousel-caption">
								<h1>Centurion</h1>
								<p class="lead">Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies
									vehicula ut id elit.</p>
								<a class="btn btn-large btn-primary" href="#">Sign up today</a>
							</div>
						</div>
						<div class="span6">
							<img src='<c:url value="/template/web/img/slide/slide1.jpg"/>'>
						</div>
					</div>
				</div>
			</div>
			<div class="item">
				<div class="container">
					<div class="row">
						...
						<div class="span6">
							<img src='<c:url value="/template/web/img/slide/slide2.jpg"/>'>
						</div>
					</div>
				</div>
			</div>
		...
		<!-- Carousel nav -->
		<a class="carousel-control left " href="#myCarousel" data-slide="prev"><i class="icon-chevron-left"></i></a> <a class="carousel-control right" href="#myCarousel"
...
==============================================-->
	<div class="row feature-box">
		...
		<div class="span4">
			...
			<h2>
				<fmt:message key="label.examination" bundle="${lang}" />
			</h2>
	...
	<div class="row">
		...
		<div class="span6">
			...
			<p>Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet,
				ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo.</p>
